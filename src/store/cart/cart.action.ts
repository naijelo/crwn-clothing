...
export type SetCartItem = ActionWithPayload<CART_ACTIONS_TYPES.SET_CART_ITEMS, CartItem[]>
...
export const setCartItems = withMatcher((cartItems: CartItem[]): SetCartItem => createAction(CART_ACTIONS_TYPES.SET_CART_ITEMS, cartItems));
