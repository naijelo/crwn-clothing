...
export const setCurrentUser = withMatcher((user: SetCurrentUser) => 
...
export const signOutSuccess = withMatcher((): SignOutSuccess => createAction(USER_ACTION_TYPES.SIGN_OUT_SUCESS));

export const signOutFailure = withMatcher((error: Error) => createAction(USER_ACTION_TYPES.SIGN_OUT_FAILURE, error));